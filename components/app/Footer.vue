<template>
  <footer class="h-16 relative w-full border-t dark:border-gray-800 z-20 mt-4 lg:mt-8">
      ...
      <div class="flex items-center space-x-4">
        ...
        >
          <span class="rounded-lg bg-gray-200 dark:bg-gray-800 p-1">
            <FontAwesomeIcon :icon="fa.terminal" class="text-primary-500 text-lg pt-1" />
          </span>
          <span class="text-xl ml-1/2">kilic.dev</span>
        </a>
      </div>
    </div>
    <div class="block dark:bg-gray-900" style="padding-block: 40px"></div>
  </footer>
</template>
