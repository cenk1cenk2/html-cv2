<template>
  <div class="p-2 lg:p-4 bg-gray-100 dark:bg-gray-800 container shadow-xl">
    ...
    <ul class="pt-2">
      <li v-for="(t, index) in timelineData" :key="index" class="flex flex-row items-center h-28 lg:h-36">
        ...
        <div
          class="block border-2 bg-white lg:border-4 border-gray-200 dark:border-gray-700 w-16 h-16 lg:w-24 lg:h-24 shadow-xl rounded-full flex items-center overflow-hidden"
          :class="[t.fixedBg ? 'dark:bg-white' : 'dark:bg-gray-800']"
        >
          <div
            class="w-3/5 h-3/5 bg-center bg-contain bg-no-repeat flex flex-auto overflow-hidden"
